...
@Component({
  selector: 'app-voc-chart',
  templateUrl: './voc-chart.page.html',
  styleUrls: ['./voc-chart.page.scss'],
})
export class VocChartPage implements AfterViewInit {
...
// 라인차트
lineChartMethod() {
  const vocChart = firebase.database().ref('/records/'+this.deviceid+'/voc').limitToLast(100);
  ...
  vocChart.once('value', function(snapshot) { 

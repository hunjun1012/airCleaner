...
@Component({
  ...
  templateUrl: './dust-chart.page.html',
  styleUrls: ['./dust-chart.page.scss'],
})
export class DustChartPage implements AfterViewInit {
...
// 라인차트
lineChartMethod() {
  const dustChart = firebase.database().ref('/records/'+this.deviceid+'/dust').limitToLast(100);
  ...
  dustChart.once('value', function(snapshot) { 

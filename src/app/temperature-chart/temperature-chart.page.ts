...
export class TemperatureChartPage implements AfterViewInit {
...
// 라인차트
lineChartMethod() {
  const temperatureChart = firebase.database().ref('/records/'+this.deviceid+'/temperature').limitToLast(100);
  ...
  temperatureChart.once('value', function(snapshot) { 
